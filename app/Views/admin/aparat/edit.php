                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <select name="jabatan" id="jabatan" class="form-control">
                                ...
                                <?php foreach ($jabatan as $row) : ?>
                                    <option value="<?= $row->id ?>" <?= $jabatan_id == $row->id ? 'selected' : ''; ?>><?= $row->name; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="tgl_pengangkatan" id="tgl_pengangkatan" type="date" class="form-control" value="<?= $tgl_pengangkatan ?>" placeholder="Tanggal Lahir">
                            <div class="invalid-feedback errorTanggalPengangkatan">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">No SK</label>
                            <input name="no_sk" id="no_sk" type="text" class="form-control" value="<?= $no_sk ?>" placeholder="No SK">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input name="no_hp" id="no_hp" type="number" class="form-control" value="<?= $no_hp ?>" placeholder="No Telepon">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="/images/aparat/<?= $foto ?>" alt="default-sampul" class="img-thumbnail img-preview">
                                </div>
                                <div class="col-md-8">
                                    <input name="foto" id="foto" type="file" value="<?= $foto ?>" class="form-control" placeholder="Foto" onchange="previewImg()">
