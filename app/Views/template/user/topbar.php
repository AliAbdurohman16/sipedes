...
$pengajuan = $db->table('pengajuan')->where('nik', session()->get('penduduk')->nik)->where('status', 'Sudah Dibuat')->orderBy('created_at','DESC')->get()->getResult();
    ...
    <div class="header-bar d-flex justify-content-between border-bottom">
        <div class="d-flex align-items-center">
            <a href="#" class="logo-icon me-3">
                <img src="<?= base_url() ?>/assets/images/logo_sipedes.png" height="30" class="small" alt="">
                <span class="big">
                    <img src="<?= base_url() ?>/assets/images/logo_sipedes.png" height="24" class="logo-light-mode" alt="">
                    <img src="<?= base_url() ?>/assets/images/logo_sipedes.png" height="24" class="logo-dark-mode" alt="">
                </span>
            </a>
        ...
        <ul class="list-unstyled mb-0">
                    ...
                    <div class="dropdown-menu dd-menu shadow rounded border-0 mt-3 p-0" data-simplebar style="height: 320px; width: 290px;">
                        ...
                        <div class="p-3">
                            <?php foreach ($pengajuan as $p) : ?>
                                <div onclick="detailPengajuanDibuat(<?= $p->id ?>)" class="dropdown-item features feature-primary key-feature p-0 mb-2">
                                    <div class="d-flex align-items-center">
                                        <div class="icon text-center rounded-circle me-2">
                                            <i class="fa-solid fa-envelope-circle-check"></i>
                                        </div>
                                        <div class="flex-1">
                                            <h6 class="mb-0 text-dark title <?= ($p->read_user == 'no' ? 'fw-bold' : '') ?>">Pengajuan Sudah Dibuat</h6>
                                            <small class="text-muted">
                                                <?php
                                                $time = Time::parse($p->updated_at, 'Asia/Jakarta');
                                                echo $time->humanize();
                                                ?>
                                            </small>
                                        </div>
            ...
            <li class="list-inline-item mb-0 ms-1">
                <div class="dropdown dropdown-primary">
                    <button type="button" class="btn btn-soft-light dropdown-toggle p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('images/avatar/Avatar.png') ?>" class="avatar avatar-ex-small rounded" alt=""></button>
