...
<nav id="sidebar" class="sidebar-wrapper sidebar-dark">
    <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
        ...
        <ul class="sidebar-menu">
            ...
            <?php endif; ?>
            <li class="<?= ($uri->getSegment(1) == 'users' ? 'active' : '') ?>"><a href="<?= base_url('admin/users') ?>"><i class="fa-solid fa-users-between-lines me-2"></i>Penduduk</a></li>
            <li><a href="index.html"><i class="fa-solid fa-users me-2"></i>Pengguna</a></li>
